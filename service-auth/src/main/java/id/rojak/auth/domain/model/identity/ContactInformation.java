...
public class ContactInformation extends AssertionConcern implements Serializable {
    ...
    @AttributeOverrides({
            @AttributeOverride(name="address",
                    column=@Column(name="contact_information_email_address_address"))})
    @Embedded
    ...
    @AttributeOverrides({
            @AttributeOverride(name="number",
                    column=@Column(name="contact_information_primary_telephone_number"))})
    @Embedded
    private Telephone primaryTelephone;

    @AttributeOverrides({
            @AttributeOverride(name="number",
                    column=@Column(name="contact_information_secondary_telephone_number"))})
    @Embedded
